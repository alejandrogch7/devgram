    ...
    <div class="w-full md:w-8/12 lg:w-6/12 flex flex-col items-center md:flex-row">
        <div class="md:w-8/12 lg:w-6/12 px-5">
            <img src="{{ 
                ...
                asset('img/usuario.svg') }}" alt="User Image" />
        </div>
        <div
            ...
            <form action="{{ route('users.follow', $user) }}" method="POST">
                @csrf
                <input type="submit"
                    class="bg-blue-600 border-2 border-blue-600 text-white uppercase rounded-lg px-3 py-1 text-sm font-bold cursor-pointer"
                    value="Follow" name="" id="">
            ...
            <form action="{{ route('users.unfollow', $user) }}" method="POST">
                ...
                @method('DELETE')
                <input type="submit"
                    class="bg-none border-2 border-blue-600 uppercase rounded-lg px-3 py-1 text-sm text-blue-600 font-bold cursor-pointer"
                    value="Unfollow" name="" id="">
...
<section class="container mx-auto mt-10">
    ...
    @else
    <p class="text-gray-600 uppercase text-sm text-center font-bold">Nothing posted yet</p>
    @endif
